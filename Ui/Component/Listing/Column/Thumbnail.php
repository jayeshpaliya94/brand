        ...
        if (isset($dataSource['data']['items'])) {
            ...
            foreach ($dataSource['data']['items'] as & $item) {
                if ($item['image']) {
                    ...
                    $item[$fieldName . '_src'] = $path.'commercepundit/brandmanagement/placeholder/placeholder.jpg';
                    $item[$fieldName . '_alt'] = 'Place Holder';
                    $item[$fieldName . '_orig_src'] = $path.'commercepundit/brandmanagement/placeholder/placeholder.jpg';
                }
            }
        }
